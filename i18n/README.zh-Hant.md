...
| [`config/`](../config/) | 已審核的 9×9 KataGo 分析配置 |
...
持久的、允許的選擇器支持 `en`、`ar`、`es`、`fr`、`ja`、`ko`、`vi`、`zh-Hans`、`zh-Hant`、`de` 和 `ru`。每個地區都有相同的 409 個明確消息鍵和相同的插值佔位符。文件語言遵循選擇，阿拉伯語將頁面切換為從右到左的佈局。
