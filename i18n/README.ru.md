...
Path of Influence — это приложение для обучения, ориентированное на локальные данные, для игры в Го/Weiqi. Оно переходит от коротких уроков 5×5 и 7×7 к полным играм 9×9 с объясняющим спутником, ограниченными игровыми агентами, театром с озвучиванием агентов и воспроизводимой хроникой. Точные правила остаются авторитетными, даже когда каждый анализ или поставщик языковой модели оффлайн.
...
- Обычные игры используют объявленные правила китайской зоны; тренировочные варианты помечены.
...
Это производственное учебное приложение, находящееся в активной разработке, а не одноразовая демонстрация настольной игры. Исходный код лицензирован по MIT; KataGo и загруженные сети сохраняют свои лицензии и не фиксируются здесь. Текущий стандарт — 9×9, в то время как 13×13 и 19×19 остаются запланированными, отдельно бюджетированными мостами.
